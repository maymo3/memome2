...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("http",(()=>{"use strict";function e(...e){
...
contains:[n.SHEBANG({binary:"ruby"})].concat(E).concat(t).concat(_)}}})());hljs.registerLanguage("haml",(()=>{"use strict";return e=>({name:"HAML",
...
subLanguage:"ruby"}}]})})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
